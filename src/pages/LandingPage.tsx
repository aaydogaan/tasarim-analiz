...
export default function LandingPage({ onStart, onVitrinClick, onCommunityClick }: LandingPageProps) {
    ...
    return (
        <div className="min-h-screen bg-[var(--color-brand-light)] text-[var(--color-brand-dark)] font-sans overflow-x-hidden selection:bg-[#ff4d00] selection:text-white">
            ...
            <nav className="absolute top-0 left-0 w-full z-50 flex items-center justify-between px-8 md:px-16 pt-8 pb-4 bg-transparent">
                {/* Logo Area */}
                ...
                {/* Center Links */}
                <div className="hidden md:flex items-center gap-10 text-[13px] font-medium text-[#666666]">
                    <button
                ...
                <button
                    onClick={onStart}
                    className="px-6 py-2.5 rounded-full text-[#ebebeb] text-[13px] font-medium transition-all hover:scale-105 bg-[#4A4A4A] hover:bg-[#333] shadow-sm tracking-wide"
                >
                    Hemen Başla
                </button>
            </nav>
            ...
            {/* Hero Section */}
            <main className="flex flex-col items-center pt-48 pb-12 px-4 relative z-10 w-full max-w-6xl mx-auto">
                <motion.div
                ...
                >
                    <div className="relative mt-10 md:mt-16 group">
                        ...
                        <div className="absolute -inset-10 pointer-events-none z-20 overflow-hidden select-none">
                            ...
                            <motion.div
                                ...
                                className="absolute w-[350px] h-[350px] bg-white/[0.04] backdrop-blur-[12px] rounded-full"
                                style={{
                            ...
                            <motion.div
                                ...
                                className="absolute w-[300px] h-[300px] bg-white/[0.03] backdrop-blur-[8px] rounded-full"
                                style={{
                                    maskImage: 'radial-gradient(circle at center, black 0%, transparent 75%)',
                                    WebkitMaskImage: 'radial-gradient(circle at center, black 0%, transparent 75%)',
                                }}
                            ...
                            <motion.div
                                ...
                                className="absolute w-[200px] h-[200px] bg-white/[0.05] backdrop-blur-[4px] rounded-full"
                                style={{
                        ...
                        <div className="text-[42px] md:text-[64px] lg:text-[88px] font-display font-bold leading-[1.1] tracking-[-0.03em] flex flex-col items-center relative z-10 transition-all duration-700 group-hover:scale-[1.01]">
                            {/* Line 1 */}
                            <div className="flex flex-wrap justify-center items-center gap-x-3 md:gap-x-4 gap-y-2 py-1">
                                <span className="text-[var(--color-brand-dark)]">Yapay Zeka</span>
                                <motion.div
                                    animate={{ y: [0, -6, 0], rotate: [0, 3, -3, 0] }}
                                    transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
                                    className="w-[45px] md:w-[80px] h-[45px] md:h-[80px] rounded-[50%] overflow-hidden relative shadow-[0_8px_30px_rgb(255,77,0,0.3)] bg-[#FF4D00] flex items-center justify-center -mb-2"
                                >
                            ...
                            <div className="flex flex-wrap justify-center items-center gap-x-3 md:gap-x-4 gap-y-2 py-1">
                                ...
                                <motion.div
                                    ...
                                    className="w-[45px] md:w-[80px] h-[45px] md:h-[80px] rounded-[50%] overflow-hidden relative shadow-lg -mb-2 border border-[var(--color-brand-dark)]/5"
                                >
                    ...
                    <p className="mt-8 text-[#7A7A7A] text-[15px] md:text-[17px] max-w-2xl mx-auto leading-relaxed font-medium">
            ...
            <div className="w-full overflow-hidden py-32 relative flex flex-col items-center justify-center bg-[var(--color-brand-light)] mt-10">
                {/* Orange Banner */}
                <div className="absolute w-[120vw] -left-[10vw] bg-[#FF4D00] py-4 md:py-5 transform rotate-[-4deg] z-10 whitespace-nowrap overflow-hidden flex shadow-2xl outline outline-2 outline-white/10">
                    <motion.div
                        animate={{ x: ["0%", "-50%"] }}
                        transition={{ duration: 200, ease: "linear", repeat: Infinity }}
                        className="flex items-center text-white text-2xl md:text-3xl lg:text-4xl font-display font-black tracking-tight w-max"
                    >
                        {Array(15).fill("Arayüz Analizi ✕ Renk Uyumu ✕ Tipografi ✕ Kompozisyon ✕").map((text, i) => (
                            <span key={i} className="mx-6 px-2">{text}</span>
                        ))}
                    </motion.div>
                </div>
                {/* Black Banner */}
                <div className="absolute w-[120vw] -left-[10vw] bg-[#111111] py-4 md:py-5 transform rotate-[3deg] z-0 whitespace-nowrap overflow-hidden flex shadow-2xl">
                    <motion.div
                        animate={{ x: ["-50%", "0%"] }}
                        transition={{ duration: 200, ease: "linear", repeat: Infinity }}
                        className="flex items-center text-[#e0e0e0] text-xl md:text-2xl font-bold tracking-wide w-max"
                    >
            ...
            <div className="relative w-full overflow-hidden flex flex-col items-center pt-[160px] pb-[12px] bg-[var(--color-brand-light)]">
                ...
                <div className="w-full max-w-[1920px] mx-auto px-2 relative z-20">
                    <div className="relative rounded-[32px] overflow-hidden flex flex-col pt-[112px] pb-[64px] px-4 md:px-[148px]">
                        ...
                        {/* Content Container */}
                        <div className="relative z-10 w-full flex flex-col gap-[120px] md:gap-[224px]">

                            {/* Top Row: Headlines & Form */}
                            <div className="flex flex-col md:flex-row justify-between items-start w-full max-w-[1144px] gap-16 md:gap-8 mx-auto">

                                {/* Left Side: Headline */}
                                <div className="flex flex-col gap-4 w-full md:max-w-[456px]">
                                    <h2
                                        className="text-white font-sans font-medium leading-[1.1] tracking-[-1.8px]"
                                        style={{ fontSize: 'clamp(40px, 6vw, 64px)' }}
                                    >
                                        Got a project in mind?
                                    </h2>
                                    <p className="text-white/80 text-[18px] font-sans">
