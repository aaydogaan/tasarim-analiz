...
export default function TextPressure(props: TextPressureProps) {
    const {
        text = "Compressa",
    ...
    const dynamicClassName = [flex ? "text-pressure-flex" : "", stroke ? "text-pressure-stroke" : ""].filter(Boolean).join(" ");
