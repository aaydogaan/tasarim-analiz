                                ...
                                <AnimatePresence>
                                    {isNotificationsOpen && (
                                        <motion.div
                                            ...
                                            className="absolute top-full right-0 mt-3 w-80 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-2xl shadow-xl overflow-hidden py-1 z-50 flex flex-col max-h-[400px]"
                                        >
