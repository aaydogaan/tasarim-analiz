...
import { ShieldCheck, X, Lock, CreditCard, ExternalLink, Sparkles, CheckCircle2, Zap } from 'lucide-react';
...
export default function ShopierModal({ isOpen, onClose }: ShopierModalProps) {
    const handleProceedToShopier = () => {
        // Open Shopier payment window cleanly without iframe security block (Error 1042)
        const width = 600;
        const height = 750;
                        ...
                        >
                            ...
                            <div className="p-6 space-y-5">
                                ...
                                <div className="space-y-2 bg-[var(--bg-secondary)] p-4 rounded-2xl border border-[var(--border-primary)] text-xs font-semibold text-[var(--text-primary)]">
                                    ...
                                    <div className="flex items-center gap-2.5 text-emerald-600 dark:text-emerald-400">
                                        <CheckCircle2 size={16} />
                                        <span>Sınırsız Analiz & Derin Yapay Zeka Tasarım Raporları</span>
                                    </div>
                                    <div className="flex items-center gap-2.5 text-emerald-600 dark:text-emerald-400">
                                        <CheckCircle2 size={16} />
                                ...
                                >
                                    <span>Shopier Güvenli Kart Ödeme Sayfasına Git</span>
                                    <ExternalLink size={18} />
                                </button>

                                <p className="text-[11px] text-center text-[var(--text-secondary)] font-medium">
                                    Butona tıkladığınızda Shopier 3D Secure korumalı ödeme penceresi açılacaktır.
                                </p>
                            </div>
